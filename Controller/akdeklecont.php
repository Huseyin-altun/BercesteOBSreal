...
$sayi = $nesne->getRows("SELECT * FROM akademisyen_ozluk") ;
...
if(!empty( $okulno) && !empty( $adres) &&  !empty( $babaad)){
    $or3 = $nesne->Insert("INSERT INTO akademisyen (kullanici_adi,sifre, akademisyen_ozluk_id)
    VALUES (?,?,?)",array($okulno,$sifre,$sayi));
$or4 = $nesne->Insert("INSERT INTO akademisyen_ozluk (id,ad,soyad,tel_no,adres,eposta,baba_adi,tc_no)
