  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <form class="row g-3" id="duyurus">

 
  <div class="col-6 mb-3 ml-5">
    <label for="inputAddress" class="form-label">Duyuru Ekle</label>
    <input type="text" class="form-control" id="inputAddress" placeholder="Baslık Giriniz" name="baslik">
  </div>
  <div class="col-8 ml-5">
  <textarea class="form-control" placeholder="İçerik" id="floatingTextarea2" style="height: 100px" name="icerik"></textarea>
