  ...
  <div class="container-fluid">
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <form class="row g-3" id="myoekle">

 
  <div class="col-6 mb-3 ml-5">
    <label for="inputAddress" class="form-label">MYO Ekle</label>
    <input type="text" class="form-control" id="inputAddress" placeholder="MYO Adı Giriniz" name="myos">
  </div>
