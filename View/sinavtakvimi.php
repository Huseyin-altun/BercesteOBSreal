...
// Ogrenci id sine gore ogrenci ders tablosunda uyusarak yapılabılır bu sayede tablo kısılestırılmıs olur
$or3= $nesne->getRows("SELECT *
FROM ders
RIGHT JOIN sinav_takvimi
ON ders.id = sinav_takvimi.ders_kodu_id")
?>
