...
<div class="col-4 mb-3 ml-5">
  <label for="inputAddress" class="form-label">Kullanıcı Adı</label>
  <input type="text" name="okulno" class="form-control" id="inputAddress" placeholder="Kullanıcı Adı Giriniz">
</div>
<div class="col-4 mb-3 ml-5">
...
.then((willDelete) => {
  if (willDelete) {
    ...
    $.ajax({
    type:"POST",
    url:'../Controller/akdeklecont.php',
